      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1">
          ...
          <p className="mt-4 text-gray-600 text-lg font-medium">
            Good Logos Don’t Just Appear. They’re Built, A Step By Step,
            With Intent Behind Every Line.
          </p>
          ...
          <p className="mt-4 text-gray-500 text-sm leading-relaxed max-w-lg">
            ...
            Stage Is There For A Reason, To Test, Shape, And Strengthen The Idea.
