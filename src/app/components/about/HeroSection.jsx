...
export default function HeroSection() {
  ...
  return (
    <div
      id="main"
      className="w-full min-h-screen bg-[url('/about/page2-hero-pic.png')] bg-cover bg-center bg-no-repeat text-gray-800 relative overflow-hidden"
    >
      {/* Overlay */}
      {/* Top Left Gradient */}
      ...
      >
        ...
        {/* Desktop Menu */}
        <ul className="hidden text-white md:flex gap-6 lg:gap-8 text-sm font-medium">
          <li
            onClick={() => {
              router.push("/");
            }}
        ...
        {/* Desktop Button */}
        <button className="hidden cursor-pointer md:flex items-center border border-white gap-2 px-4 lg:px-5 py-2 rounded-full text-sm hover:bg-black/20 transition">
          <IoChatbubbleEllipses className="text-[#DE3B00]" size={18} />
          <span className="hidden text-white lg:inline">Let's Talk ↗</span>
        </button>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 md:px-10 lg:px-20 mt-6 sm:mt-10">
        ...
        >
          <div className="inline-flex border-white text-white  items-center gap-2 border px-3 sm:px-4 py-2 rounded-full text-[10px] sm:text-xs mb-4 sm:mb-6">
            <span className="w-2 h-2 bg-[#DE3B00] rounded-full"></span>
            Not built to blend in.
          </div>

          {/* Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl ubuntu-bold font-medium text-[#DE3B00] leading-tight">
            Trusted <span className="text-white">By Brands</span>
            <br />
            <span className="text-white">
              Across <span className="text-[#DE3B00]">New</span> York.
            </span>
          </h1>

          <p className="mt-1 md:mt-3 text-base sm:text-lg md:text-xl font-bold text-white">
            Most Brands Get Ignored. We Make Sure Yours Doesn't.
          </p>

          <p className="mt-1 md:mt-3 text-xs sm:text-sm text-gray-200 leading-relaxed">
            Brooklyn Designs Is Where Ideas Get Sharper. We Build Brands With
            Weight And Digital Experiences That Actually Perform. No Fluff. Just
            Work That Gets Noticed And Delivers.
          </p>

          <button className="mt-3 md:mt-6 bg-white text-[#DE3B00] px-5 sm:px-6 py-2.5 sm:py-3 rounded-full text-xs sm:text-sm hover:bg-[#DE3B00] hover:text-white cursor-pointer transition">
            Start Your Project ↗
          </button>
        </motion.div>
      ...
      >
        <div className="w-[1px] h-16 lg:h-20 bg-white mb-4"></div>
