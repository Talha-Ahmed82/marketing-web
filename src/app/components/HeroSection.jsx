...
export default function HeroSection() {
    ...
    >
      <div className="flex items-center justify-center">
        <Image
          ...
          alt="circle-text"
          className="w-[18%] sm:w-[20%] lg:w-[20%] -mt-40 md:-mt-96 h-auto animate-spin-slow"
        />
        ...
        >
          <Image
            ...
            width={300}
            height={300}
            className="w-[70%] sm:w-[80%] md:w-[500px] lg:w-[500px] object-contain animate-float"
          />
        </motion.div>
      </div>

      {/* Discount Badge (Hide on small screens to avoid break) */}
      <div className="hidden sm:block absolute -mt-60 md:mt-0 right-[-90px] md:right-[-100px] lg:right-[-140px] top-[30%] -translate-y-1/2 rotate-90 bg-[#DE3B00] text-white text-xs px-4 py-2 rounded-tr-full rounded-bl-full">
  ...
  <motion.div
    ...
    animate={{ opacity: 1, x: 0 }}
    transition={{ delay: 1 }}
    className="hidden md:flex absolute left-4 lg:left-6 top-1/2 -translate-y-1/2 flex-col items-center"
  >
