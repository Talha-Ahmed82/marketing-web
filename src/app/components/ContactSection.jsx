    ...
    <section className="w-full bg-white py-14 md:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 border border-gray-400 rounded-full px-4 py-2 mb-8 bg-white">
            ...
            <h2 className="font-semibold leading-[1.02] tracking-tight text-[52px] md:text-[76px] lg:text-[78px]">
              <span className="text-orange-600">Let’s</span>{" "}
              <span className="text-slate-700">Build</span>
              <br />

              <span className="text-slate-700">Something</span>{" "}
              <span className="text-orange-600">That</span>
              <br />

              <span className="text-orange-600">Actually</span>{" "}
            ...
            <button className="mt-8 bg-orange-600 hover:bg-orange-700 transition text-white rounded-full px-8 py-4 font-medium shadow-lg">
            ...
            <form className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full text-gray-600 rounded-md border border-gray-300 bg-white px-4 py-3 outline-none focus:border-orange-500"
                />
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <select className="w-full text-gray-600 rounded-md border border-gray-300 bg-white px-4 py-3 outline-none focus:border-orange-500">
              ...
              <textarea
                ...
                className="w-full rounded-md text-gray-600 border border-gray-300 bg-white px-4 py-4 outline-none focus:border-orange-500 resize-none"
              ></textarea>
